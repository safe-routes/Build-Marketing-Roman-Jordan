const people =[
    {name : 'Roman Jordan', 'roll':'','GitHandle': 'https://www.github.com/roman-jordan', 'img' : '', 'gender': 'm'},
    {name : 'Simon Davis', 'roll':'', 'GitHandle': 'https://github.com/Skidragon', 'img' : '', 'gender': 'm'},
    {name : 'Trista Paul', 'roll':'', 'GitHandle': 'https://github.com/trista-paul', 'img' : '', 'gender': 'f'},
    {name : 'Ed Chin', 'roll':'', 'GitHandle': 'https://github.com/ed-chin-git', 'img' : '', 'gender': 'm'},
    {name : 'David Barrios', 'roll':'', 'GitHandle': 'https://github.com/dbarrios13', 'img' : '', 'gender': 'm'},
    {name : 'Jeff Lapp', 'roll':'', 'GitHandle': 'https://github.com/lappjeff', 'img' : '', 'gender': 'm'},
    {name : 'Carlos Gutierrez', 'roll':'', 'GitHandle': 'https://github.com/carlos-gutier', 'img' : '', 'gender': 'm'},
    {name : 'Brian Illes', 'roll':'Back-end Architect', 'GitHandle': 'https://github.com/brilles', 'img' : '', 'gender': 'm'}
  ];
